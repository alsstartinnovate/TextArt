package com.startup.textart.fragments.imagetools;
...
public class PhotoFragment extends Fragment {
    ...
    public PhotoBackListener mPhotoBackListener;
    ...
    public interface PhotoBackListener {
        void onPhotoBackClick(String str);
    }
    ...
    public void setBackPhotoListener(PhotoBackListener photoListener) {
        this.mPhotoBackListener = photoListener;
    }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                view.setOnClickListener(view1 -> {
                    ...
                    }else if (PhotoFragment.this.mPhotoBackListener != null) {
                        PhotoFragment.this.mPhotoBackListener.onPhotoBackClick(PhotoAdapter.this.stringArrayList.get(ViewHolder.this.getLayoutPosition()));
                    }
                });
            }
        }
