package com.startup.textart.photoeditor;
...
public class StrokeTextView extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            int[] StrokeTextView = {R.attr.gradientOrientation, R.attr.strokeColor, R.attr.strokeWidth};
    ...
    private LinearGradient getGradient() {
        if (this.mGradientOrientation == 0) {
            return new LinearGradient(0.0f, 0.0f, (float) getWidth(), 0.0f, this.mGradientColor, null, Shader.TileMode.CLAMP);
        }
        return new LinearGradient(0.0f, 0.0f, 0.0f, (float) getHeight(), this.mGradientColor, null, Shader.TileMode.CLAMP);
    }
