...
import com.startup.model.BottomItemModel;
...
public class BottomItemAllAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<BottomItemModel> items = new ArrayList<>();
    private Context ctx;
    ...
    public BottomItemAllAdapter(Context context, List<BottomItemModel> items, int animation_type) {
        this.items = items;
        ctx = context;
...
//            cardView = (CardView) v.findViewById(R.id.cardview);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bottom_all, parent, false);
