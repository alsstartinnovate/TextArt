...
import com.startup.model.BottomItemOneModel;
...
public class BottomItemOneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<BottomItemOneModel> items = new ArrayList<>();
    private Context ctx;
    ...
    public BottomItemOneAdapter(Context context, List<BottomItemOneModel> items, int animation_type) {
        this.items = items;
        ctx = context;
...
//            cardView = (CardView) v.findViewById(R.id.cardview);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_bottomitemone, parent, false);
