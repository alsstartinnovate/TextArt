...
import com.anilax.customdesign.interfaces.ItemClickListener;
import com.anilax.customdesign.model.Sample;
import com.anilax.customdesign.views.CircleImageView;
...
public class BackgroundColorAdapter extends RecyclerView.Adapter<BackgroundColorAdapter.ViewHolderColor> {
    ...
    public BackgroundColorAdapter(List<Sample> arrayList, Context context, ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderColor viewHolderColor, int i) {
        Glide.with(this.context).load(this.sampleArrayList.get(i).getImgSample()).thumbnail(0.1f).into(viewHolderColor.circleImageView);
    }
