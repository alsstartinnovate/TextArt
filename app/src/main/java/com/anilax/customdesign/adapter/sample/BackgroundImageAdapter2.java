...
public class BackgroundImageAdapter2 extends RecyclerView.Adapter<BackgroundImageAdapter2.ViewHolderImage2> {
    ...
    public BackgroundImageAdapter2(List<Sample> arrayList, Context context, ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderImage2 viewHolderImage2, int i) {
        Glide.with(this.context).load(this.sampleArrayList.get(i).getImgSample()).thumbnail(0.1f).into(viewHolderImage2.roundedImageView);
    }
