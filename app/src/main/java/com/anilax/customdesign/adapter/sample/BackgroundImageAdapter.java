...
public class BackgroundImageAdapter extends RecyclerView.Adapter<BackgroundImageAdapter.ViewHolderImage> {
    ...
    public BackgroundImageAdapter(List<Sample> arrayList, Context context, ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolderImage viewHolderImage, int i) {
        Glide.with(this.context).load(this.sampleArrayList.get(i).getImgSample()).thumbnail(0.1f).into(viewHolderImage.roundedImageView);
    }
