package com.anilax.customdesign.fragments.imagetools;
...
import com.anilax.customdesign.fragments.imagetools.sticker.StickerViewPagerAdapter;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < childCount2; i2++) {
                ...
                if (childAt instanceof TextView) {
                    ((TextView) childAt).setTypeface(Typeface.createFromAsset(Objects.requireNonNull(getActivity()).getAssets(), "roboto_regular.ttf"));
                }
            }
        }
    }
