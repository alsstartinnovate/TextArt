package com.anilax.customdesign.views;
...
public class SquareRoundRectView extends ShapeOfView {
    ...
    public SquareRoundRectView(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public SquareRoundRectView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        super(context, attributeSet);
        init(context, attributeSet);
    }

    public SquareRoundRectView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        super.setClipPathCreator(new ClipPathManager.ClipPathCreator() {
            ...
            public Path createClipPath(int i, int i2) {
                ...
                float a2 = squareRoundRectView2.min(squareRoundRectView2.topLeftRadius, f, f2);
                SquareRoundRectView squareRoundRectView3 = SquareRoundRectView.this;
                float a3 = squareRoundRectView3.min(squareRoundRectView3.topRightRadius, f, f2);
                SquareRoundRectView squareRoundRectView4 = SquareRoundRectView.this;
                float a4 = squareRoundRectView4.min(squareRoundRectView4.bottomRightRadius, f, f2);
                SquareRoundRectView squareRoundRectView5 = SquareRoundRectView.this;
                return squareRoundRectView.generatePath(squareRoundRectView.rectF, a2, a3, a4, squareRoundRectView5.min(squareRoundRectView5.bottomLeftRadius, f, f2));
            }
        });
    }
