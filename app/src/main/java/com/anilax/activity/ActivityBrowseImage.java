...
public class ActivityBrowseImage extends AppCompatActivity implements
        View.OnClickListener, UCropFragmentCallback {
...
//                  .setRootDirectoryName(Config.ROOT_DIR_DCIM)
                    ...
                    .setMaxSize(1)
                    .setLimitMessage("You can select only 1 images")
    ...
    private void browseImageFromCamera() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA)
            ...
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                ...
                File createDir = new File(Environment.getExternalStorageDirectory(), "/" +
                        getResources().getString(R.string.app_name)+ "/");
                File photoFile = new File(Environment.getExternalStorageDirectory(), "/" +
                        getResources().getString(R.string.app_name)+ "/photo_" + timeStamp + ".jpg");
                if (!createDir.exists()) {
                    createDir.mkdirs();
                }
//                imageUri = Uri.fromFile(photoFile);
    ...
    private void startCrop(@NonNull Uri uri) {
        ...
        uCrop.start(ActivityBrowseImage.this);
        ...
        if (resultCode == RESULT_OK) {
            ...
            for (int i = 0; i < images.size(); i++) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    uri = images.get(i).getUri();
                } else {
                    uri = Uri.fromFile(new File(images.get(i).getPath()));
                }
                startCrop(uri);
            }
        }
            ...
            showAlertDialog(getString(R.string.permission_title_rationale), rationale,
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(ActivityBrowseImage.this,
