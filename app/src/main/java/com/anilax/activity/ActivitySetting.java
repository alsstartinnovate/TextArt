...
public class ActivitySetting extends AppCompatActivity implements View.OnClickListener, WebServiceListener {
...
//        btnBack = (Button) allViewWithClick[0];
    ...
    private void StartApp() {
        ...
        errrorScreen = new NoInternetScreen(svContext, root, ActivitySetting.this);
...
//            FontUtils.setThemeColor(root, svContext, false);
    ...
    private void loadToolBar(){
        ...
        txtHeading.setText(getString(R.string.toolbar_setting));
    }
